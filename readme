...
## Controls
mouse click to select a chess piece and move it
1/2 to undo / redo moves.
'i' starts instant replay mode, which replays the entire game
after undoing / redoing or starting instant reply mode, the AI opponent can be turned back on by pressing 'r'
